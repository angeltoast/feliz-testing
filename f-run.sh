...
NewMirrorList() { # Use rankmirrors (script in /usr/bin/ from Arch) to generate fast mirror list
  ...
  # Above removed as unnecssary (done by pacstrap) - see https://wiki.archlinux.org/index.php/Installation_guide#Installation
...
read -p "Shutdown Reboot translates as :$Result:"

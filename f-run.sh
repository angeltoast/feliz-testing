...
NewMirrorList() { # Use rankmirrors (script in /usr/bin/ from Arch) to generate fast mirror list
  ...
  # All code copied here was tested and worked in New Feliz iso Workshop/Testbed
  # NOTE: This code cannot be tested in Debian, as the Arch Linux script rankmirrors does not work
  ...
  rm usemirrors.list countries.list allmirrors.list mirrorlist.new  # Delete working files

read -p "Now check /etc/pacman.d/mirrorlist"
